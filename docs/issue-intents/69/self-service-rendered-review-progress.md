...
with one URL field, no Bash browser permission, fixed private Safari argv,
strict public Factory path/query/fragment validation, and no reuse of the normal
Safari session. Follow-up review corrected the OpenCode 1.18.19 discovery extension and
...
opening, bounded Safari screenshots, hosted checks, integration, and closeout
